...
public class TriggerRoom1Transition : MonoBehaviour
{
    ...
    public Color shine = Color.white;
    ...
    void Update()
    {
        ...
        if (distanceToPlayer <= maxDistance && enemyCount <= 0)
        {
            ...
            // renderer.material.color = Color.Lerp(renderer.material.color, shine, Mathf.PingPong(Time.time * spd, length));
            ...
            // }
            //GameObject signal = GameObject.FindGameObjectWithTag("Signal");
            signal.SetActive(true);
        }
